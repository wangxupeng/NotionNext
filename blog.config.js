...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Akon Wong', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个热爱生活的AI爱好者，希望能分享一点有意思的东西', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://https://www.akjourneys.cn/', // 网站地址
